...
function codelighter_plugin_settings() {
	...
	add_settings_field( 'primer_field3', __('Selected color', 'codelighter'), 'codelighter_option_selected_color', 'codelighter_page', 'codelighter_main_settings' );
...
function codelighter_option_selected_color() {
	...
	<input type="color" id="cl-sc" name="codelighter[selected-color]" value="<?php echo $codelighter_val; ?>"> <br>
	<?php
}
...
function codelighter_option_favorites() {
	...
	<p><?php var_dump(get_option( 'codelighter' )) ?></p>
	<?php
}
